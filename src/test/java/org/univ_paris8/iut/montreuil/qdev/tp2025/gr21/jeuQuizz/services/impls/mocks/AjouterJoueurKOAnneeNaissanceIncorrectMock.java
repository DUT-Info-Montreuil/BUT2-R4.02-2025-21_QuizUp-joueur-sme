...
import org.univ_paris8.iut.montreuil.qdev.tp2025.gr21.jeuQuizz.utils.exceptions.ajouterJoueurDTOExceptions.anneeNaissanceExceptions.AnneeNaissanceException;

import java.util.List;

public class AjouterJoueurKOAnneeNaissanceIncorrectMock implements IJoueurServices {
    @Override
    public JoueurDTO ajouterJoueur(String pseudo, String prenom, int anneeNaissance, List<String> centresInterets, String languePreferee) throws AjouterJoueurException {
        throw new AnneeNaissanceException("Annee de naissance incorrect");
    }
